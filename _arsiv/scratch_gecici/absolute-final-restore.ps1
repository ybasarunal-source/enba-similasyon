...
# 2. Step 4 (Personnel)
Fix-File "components\wizard\detailed\DetStep4_Personnel.jsx" 36 "                <h3 style={{ fontSize:'13px', margin:'0 0 10px', color:'var(--enba-dark)' }}>${bolt} ${I_dot}${s_low}ci / Personel Rolü Tanımla</h3>"

# 3. Step 6 (Investment)
Fix-File "components\wizard\detailed\DetStep6_Investment.jsx" 43 "                            <option value=""makina"">${gear} Makina</option>"
Fix-File "components\wizard\detailed\DetStep6_Investment.jsx" 44 "                            <option value=""insaat"">${build} ${I_dot}n${s_low}aat / Tesis</option>"
Fix-File "components\wizard\detailed\DetStep6_Investment.jsx" 45 "                            <option value=""diger"">${tools} Di${g_low}er</option>"

# 4. app.jsx
Fix-File "app.jsx" 156 "                        // ${S_cap}ablon formatı: [KOD, KALEM ADI, TUTAR]"

Write-Host "ABSOLUTE FINAL RESTORATION COMPLETE"

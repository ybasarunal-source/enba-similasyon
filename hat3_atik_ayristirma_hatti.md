...
| Kağıt / karton | Kağıt geri dönüşüm tesisi | Bu wikinin kapsamı dışında |
| Cam | Cam geri dönüşüm tesisi | Bu wikinin kapsamı dışında |
...
- **PVC kontaminasyonu gözden kaçıyor:** Az miktarda PVC bile PET fraksiyonunu bozar. NIR PVC'yi tanır ancak küçük parçaları veya kısmen örtülü parçaları gözden kaçırabilir. XRF spot kontrol ve picking station şart.
...
*Sayfa durumu: Taslak v1 · Hat 4 (Kimyasal Geri Dönüşüm Hattı) için → bkz. hat4_kimyasal_geri_donusum.md*

...
### Oturum Sonunda (bunları yaparak bitir)
1. Değişen/eklenen wiki sayfalarını güncelle
2. `index.md`'yi güncelle (yeni sayfa varsa)
3. `log.md`'ye yeni giriş ekle:
   ```
   ## [YYYY-MM-DD] geliştirme | Yapılan işin özeti
   - Yapılan: ...
   - Güncellenen sayfalar: ...
   - Bir sonraki: ...
   ```
4. `Aktif Görevler` bölümünü bir sonraki oturum için hazırla
